...
wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[1]/section/main/article/div[2]/div[1]/div/form/div/div[3]/button/div')))
login_button = driver.find_element_by_xpath('/html/body/div[1]/section/main/article/div[2]/div[1]/div/form/div/div[3]/button/div')
login_button.click()

wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[1]/section/main/div/div/div/div/button')))
dismiss_button = driver.find_element_by_xpath('/html/body/div[1]/section/main/div/div/div/div/button')
dismiss_button.click()

wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div/div/div/div[3]/button[2]')))
dismiss_button = driver.find_element_by_xpath('/html/body/div[4]/div/div/div/div[3]/button[2]')
dismiss_button.click()
...
# Dismiss follower box if previously searched
try:
    dismiss = driver.find_element_by_xpath('/html/body/div[4]/div/div/div[1]/div/div[2]/button')
    dismiss.click()
...
wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[1]/section/nav/div[2]/div/div/div[2]/div[3]/div[2]/div/a[1]/div/div[2]/div/span')))
...
wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[1]/section/main/div/header/section/ul/li[2]/a/span')))
...
# Allow popup to load
wait.until(EC.element_to_be_clickable((By.XPATH, '//div[@class="isgrP"]')))
wait.until(EC.element_to_be_clickable((By.XPATH, '//div[@class="PZuss"]')))
...
try:
    while (not done):
        ...
        time.sleep(0.1)
        driver.execute_script('arguments[0].scrollTop = arguments[0].scrollTop + arguments[0].offsetHeight;', f_body) # scroll down
        if (height == track_height.size['height']): # List didn't refresh, check for end
            fetched_followers = len(driver.find_elements_by_css_selector('a.FPmhX.notranslate._0imsa'))
            if (fetched_followers == follower_count):
                done = True
            print(str(fetched_followers) + " followers loaded so far")
...
print("Found " + str(followers_found) + " followers")
